  ...
  .then((content) => {
    ...
    for (let i = 0; i < content.data.length; i++) {
      ...
      >
        ...
        <div class='px-2 title'>${content.data[i].title}</div>

        <div></div>

        <div class='px-2 duration'>${content.data[i].duration}</div>
      </li>
      <li
        class = 'list-group-item d-flex align-items-center bg-transparent border-0 text-white px-0'
      >
        ...
        <div class='px-2 title'>${content.data[i + 3].title}</div>

        <div></div>

        <div class='px-2 duration'>${content.data[i + 3].duration}</div>
      </li>
      <li
        class = 'list-group-item d-flex align-items-center bg-transparent border-0 text-white px-0'
      >
        ...
        <div class='px-2 title'>${content.data[i + 5].title}</div>

        <div></div>

        <div class='px-2 duration'>${content.data[i + 5].duration}</div>
      </li>
      <li
        class = 'list-group-item d-flex align-items-center bg-transparent border-0 text-white px-0'
      >
        ...
        <div class='px-2 title' >${content.data[i + 7].title}</div>

        <div></div>

        <div class='px-2 duration'>${content.data[i + 7].duration}</div>
      </li>
      <li
        class = 'list-group-item d-flex align-items-center bg-transparent border-0 text-white px-0'
      >
        ...
        <div class='px-2 title'>${content.data[i + 9].title}</div>

        <div></div>

        <div class='px-2 duration'>${content.data[i + 9].duration}</div>
      </li>`);
